...
def _metadata_to_service(metadata: Dict[str, Any]) -> Service:
    ...
    return Service(
        ...
        alternate_name=metadata.get("AlternateName"),
        parent_agency=metadata.get("ParentAgency"),
        agency_status=metadata.get("AgencyStatus"),
        agency_description=metadata.get("AgencyDescription"),
        agency_description_site=metadata.get("AgencyDescription_Site"),
        coverage_area=metadata.get("CoverageArea"),
        coverage_area_text=metadata.get("CoverageAreaText"),
        eligibility=metadata.get("Eligibility"),
        disabilities_access=metadata.get("DisabilitiesAccess"),
        hours_of_operation=metadata.get("HoursOfOperation"),
        languages_offered=metadata.get("LanguagesOffered"),
        last_verified_on=metadata.get("LastVerifiedOn"),
        last_verified_by_name=metadata.get("LastVerifiedByName"),
        last_verified_by_email=metadata.get("LastVerifiedByEmailAddress"),
        application_process=metadata.get("ApplicationProcess"),

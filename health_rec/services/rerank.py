...
class ReRankingService:
    ...
    def _create_ranking_prompt(self, query: str, services: List[Service]) -> List[Dict[str, str]]:
    ...
    def _process_ranking_response(
        ...
        try:
            ...
            return [services[i] for i in rankings[:self.config.output_k]]
